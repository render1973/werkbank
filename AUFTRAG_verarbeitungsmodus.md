# Auftrag für Claude Code: Verarbeitungs-Schalter "Transkript / Protokoll Cloud / Protokoll lokal" einbauen

> Diese Datei heisst bewusst NICHT mehr "AUFTRAG_claude_code.md" — es gibt
> einen zweiten, unabhängigen Auftrag (Projektansicht/Typografie) mit
> diesem generischen Namen. Bitte diese Datei explizit referenzieren:
> "Lies AUFTRAG_verarbeitungsmodus.md und setz das um."
...
6. **Frontend (`templates/index.html` bzw. deren Äquivalent im Hub):** vor dem Upload-Formular einen
   ...
   Default: `protokoll_cloud` — vom Nutzer final bestätigt. Cloud-Protokoll
   ist der Regelfall; "Nur Transkript" ist die bewusste Ausnahme für heikle
   Besprechungen, die aktiv gewählt wird (nicht umgekehrt).
